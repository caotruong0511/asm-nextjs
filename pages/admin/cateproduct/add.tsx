...
import { type } from "os";
import { addCateProduct } from "../../../redux/cateProductSlice";
...
const CateProductAdd:NextPageWithLayout = (props: Props) => {
...
CateProductAdd.getLayout = (page: ReactElement) => <AdminLayout>{page}</AdminLayout>;
