...
const News = (props: Props) => {
    return (
        <div className='container-base grid grid-cols-2 gap-4'>
            ...
            <div className='flex justify-between'>
                <img src="" alt="" className='w-[160px] h-[140px]' />
                <div className='pl-2' >
                    <span className='text-[21px] font-barlow  hover:text-green-600  leading-[30px] '>UỐNG TRÀ CÓ MẤT NGỦ KHÔNG?</span>
                    <p className='text-[14px] mt-2 font-quicksand' >Đối với nhiều người, một ngày mới chỉ có thể khởi đầu tốt đẹp...</p>
                </div>
            </div>
            <div className='flex justify-between'>
